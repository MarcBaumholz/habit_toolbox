...
function findSolution() {
    ...
    try {
        ...
        showNotification('Fehler bei der Analyse. Bitte versuche es erneut.', 'error');
    }
}
...
async function analyzeProblem(problem) {
    try {
        ...
        const response = await fetch('/api/analyze-habit-problem', {
            method: 'POST',
            headers: {
        ...
        console.log('AI API nicht verfügbar, verwende erweiterte Analyse');
    }

    // Enhanced keyword-based analysis with confidence scoring
    const keywords = problem.toLowerCase();
    let confidence = 60;
    let category = 'Allgemeine Gewohnheitsbildung';
    let icon = '⚡';
    let tools = ['Habit Loop', 'Implementation Intentions', 'Progress Tracking'];
    let description = 'Wir empfehlen dir unsere allgemeine Gewohnheitsbildungs-Toolbox.';
    ...
    const patterns = {
        'fitness': { 
            ...
            icon: '🏃‍♂️', 
            tools: ['Habit Stacking', 'Environment Design', 'Accountability Partner', 'Progress Visualization'],
        ...
        'lernen': { 
            ...
            icon: '🧠', 
            tools: ['Pomodoro Technique', 'Deep Work Blocks', 'Learning Sprints', 'Focus Timer'],
        ...
        'produktivität': { 
            category: 'Lernen & Produktivität', 
            icon: '🧠', 
            tools: ['Pomodoro Technique', 'Deep Work Blocks', 'Learning Sprints', 'Time Blocking'],
            description: 'Für dein Produktivitätsproblem ist die Lernen & Produktivität Toolbox ideal.',
            confidence: 85
        },
        'schlaf': { 
            category: 'Schlaf & Erholung', 
            icon: '😴', 
            tools: ['Sleep Hygiene', 'Evening Routine', 'Digital Detox', 'Meditation'],
        ...
        'müde': { 
            category: 'Schlaf & Erholung', 
            icon: '😴', 
            tools: ['Sleep Hygiene', 'Evening Routine', 'Digital Detox', 'Energy Management'],
            description: 'Die Schlaf & Erholung Toolbox hilft dir bei deinem Problem.',
            confidence: 80
        },
        'ernährung': { 
            ...
            icon: '🍎', 
            tools: ['Meal Planning', 'Mindful Eating', 'Nutrition Tracking', 'Hydration Reminder'],
        ...
        'gesund': { 
            ...
            icon: '🍎', 
            tools: ['Meal Planning', 'Mindful Eating', 'Nutrition Tracking', 'Hydration Reminder'],
            description: 'Für dein Gesundheitsproblem ist diese Toolbox perfekt.',
            confidence: 80
        }
    };
